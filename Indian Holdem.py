...
while True:
    ...
    while fl2 == 0:
        ...
        if blueplayer.key1.isdecimal() is True and blueplayer.key2.isdecimal() is True:
            fl2 = 1
            ...
            for i in range(10):
                ...
                if firstdata == 'die':
                    ...
                    while f == 0:
                        ...
                        if firstcount.isdecimal():
                            first = int(firstcount)

                            if 1 <= first <= order[0].chip and first <= order[1].chip:
                                f = 1
                            else:
                    ...
                    if lastdata == 'fight':
                        ...
                        print("승부 결과: %s의 카드는 '%d', %s의 카드는 '%d'" % (
                            order[0].name, cardorder[0][i], order[1].name, cardorder[1][i]))
